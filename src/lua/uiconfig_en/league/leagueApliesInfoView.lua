					...
					components = 
					{
						
						{
							...
							components = 
							{
								...
								{
									controlID = "Image_leagueApliesInfoView_1_Image_bg_Panel_base_Panel-leagueApliesInfoView_Layer1_league_Game",
									UUID = "9e4920a5_e720_4695_b87d_d00b1d9d3b79",
									anchorPoint = "False",
									anchorPointX = "0.5",
									anchorPointY = "0.5",
									backGroundScale9Enable = "False",
									...
									sizeType = "0",
									srcBlendFunc = "770",
									texturePath = "ui/league/加入申请 拷贝.jpg",
									touchAble = "False",
									UILayoutViewModel = 
									{
