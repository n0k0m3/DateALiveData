						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Die folgenden Spieler bewerben sich um die Wahl des Anführers",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Das Mitglied mit dem höchsten wöchentlichen Beitrag wird der nächste Anführer.",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
