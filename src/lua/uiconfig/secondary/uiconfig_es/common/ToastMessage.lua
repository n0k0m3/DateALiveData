				...
				},
				{
					...
					components = 
					{
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "770",
							text = "TextAreaTextAreaTextAreaTextAreaTextArTextAreaTextAreaTextAreaTextAreaTextAreaTextAreaTextAreaTextAreaTextAreaeaTextAreaTextAreaTextArea",
							touchAble = "False",
							touchScaleEnable = "False",
							UILayoutViewModel = 
							{
