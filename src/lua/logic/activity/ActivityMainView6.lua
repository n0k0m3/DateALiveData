...
local ActivityMainView6 = requireNew("lua.logic.activity.ActivityMainView")
ActivityMainView6.__cname = "ActivityMainView6"
ActivityMainView6.activityShowType = 6
...
rawset(ActivityMainView6, "addActivityItem", addActivityItem)
...
rawset(ActivityMainView6, "updateActivtyItem", updateActivtyItem)
...
rawset(ActivityMainView6, "selectActivity", selectActivity)
...
rawset(ActivityMainView6, "updateActivtyItemRedPoint", updateActivtyItemRedPoint)
return ActivityMainView6