...
local DfwStepRewardView = class("DfwStepRewardView", BaseLayer)

function DfwStepRewardView:initData()
...
function DfwStepRewardView:ctor(...)
...
function DfwStepRewardView:initUI(ui)
...
function DfwStepRewardView:refreshView()
    self.Label_name:setTextById(13210008)

    self:updateAllTaskItem()
end

function DfwStepRewardView:registerEvents()
...
function DfwStepRewardView:addTaskItem()
    local foo = {}
...
function DfwStepRewardView:updateAllTaskItem()
...
function DfwStepRewardView:onSubmitSuccessEvent(activitId, itemId, reward)
    if self.activityId_ ~= activitId then return end
    Utils:showReward(reward)
    self:updateAllTaskItem()
end

function DfwStepRewardView:onUpdateProgressEvent()
    self:updateAllTaskItem()
end

return DfwStepRewardView
