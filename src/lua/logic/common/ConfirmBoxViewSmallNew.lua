...
local ConfirmBoxViewSmallNew = class("ConfirmBoxViewSmallNew", BaseLayer)

function ConfirmBoxViewSmallNew:ctor(...)
...
function ConfirmBoxViewSmallNew:initData(goodsId, extData)
...
function ConfirmBoxViewSmallNew:initUI(ui)
...
function ConfirmBoxViewSmallNew:setTitle(title)
    self.Label_title:setTitle(title)
end

function ConfirmBoxViewSmallNew:setContent(content)
    self.Label_content:setText(content)
end

function ConfirmBoxViewSmallNew:setRContent(contentId,...)
...
function ConfirmBoxViewSmallNew:setCallback(callback)
    self.callback_ = callback
end

function ConfirmBoxViewSmallNew:refreshView()
...
function ConfirmBoxViewSmallNew:registerEvents()
...
function ConfirmBoxViewSmallNew:currencyIsEnough()
	local enough = true
