						...
						},
						{
							...
							components = 
							{
								
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Increases max Spirit Power fusion level",
									touchAble = "False",
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Damage immunity from fire attributes increased by 20%. Increases damage immunity from ice attribute damage by 20%. Increases damage immunity from storm attributes by 20%. Increases damage immunity from lightning attributes by 20%",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
