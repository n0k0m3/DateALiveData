return {
    ...
    [110414] = {
        ...
        energyExplain = "Use basic attacks and skills to generate Time. Extra skill [Shooting Gallery] costs all Time. For the next 7 seconds, her active attacks have a 15% chance to summon a clone that attacks enemies.",
        camp = "Spirit",
