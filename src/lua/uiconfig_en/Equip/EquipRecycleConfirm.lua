						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "In each cycle, current Sephiroth and Keepsakes equipped by Spirits are bound to them, which means other Spirits can´t use them (they can use the stuff in Bag now)",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
