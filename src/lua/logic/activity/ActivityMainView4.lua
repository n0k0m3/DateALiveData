...
local ActivityMainView4 = requireNew("lua.logic.activity.ActivityMainView")
ActivityMainView4.__cname = "ActivityMainView4"
ActivityMainView4.activityShowType = 4
...
rawset(ActivityMainView4, "addActivityItem", addActivityItem)
...
rawset(ActivityMainView4, "updateActivtyItem", updateActivtyItem)
...
rawset(ActivityMainView4, "selectActivity", selectActivity)
...
rawset(ActivityMainView4, "updateActivtyItemRedPoint", updateActivtyItemRedPoint)
return ActivityMainView4