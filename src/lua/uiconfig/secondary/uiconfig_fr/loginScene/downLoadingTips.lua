						...
						},
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "est disponible au téléchargement, Souhaitez-vous mettre à jour maintenant ?",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Contenu mis à jour du correctif 1025",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
						...
						},
						{
							...
							components = 
							{
								
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "La mise à jour a échoué, Voulez-vous essayer à nouveau ?",
									touchAble = "False",
