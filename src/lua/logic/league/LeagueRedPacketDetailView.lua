...
local LeagueRedPacketDetailView = class("LeagueRedPacketDetailView", BaseLayer)

function LeagueRedPacketDetailView:initData(redPacketData)
    self.redPacketData = redPacketData
end

function LeagueRedPacketDetailView:ctor(redPacketData)
    self.super.ctor(self)
    self:initData(redPacketData)
    self:showPopAnim(true)
    self:init("lua.uiconfig.league.leagueRedPacketDetailView")
end

function LeagueRedPacketDetailView:initUI(ui)
...
function LeagueRedPacketDetailView:refreshView()
...
function LeagueRedPacketDetailView:registerEvents()
...
return LeagueRedPacketDetailView
