...
--]]
s2c.ACTIVITY_RES_FRIEND_HELP_REWARD_ADDRESS = 5191
...
--]]
s2c.ACTIVITY_RESP_CRAZY_DIAMOND_DRAW = 5193
...
--[[
	[1] = {--RespYearLottoInfo
		[1] = 'bool':joinStatus	[ 报名状态]
		[2] = 'int32':rewardStatus	[ 领奖状态,0 未中奖 1 可领取 2 已领取]
		[3] = 'int32':joinNum	[ 报名人数]
		[4] = 'string':address	[地址信息json]
		[5] = 'int32':realPrize	[实物奖励]
		[6] = 'int32':realRound	[实物奖励轮次]
	}
--]]
...
--]]
s2c.ZILLIONAIRE_RSP_THROW_DICE = 5220
...
--]]
s2c.ZILLIONAIRE_RSP_EQUIP_ITEM = 5221
...
--]]
s2c.YOUCI_YOUCI_REWARD_ID = 9105
...
--]]
s2c.ACTIVITY_RES_DRAW_COMPASS = 5192
...
--[[
	[1] = {--BuyMonthCardInfo
		[1] = {--GetMonthCardInfo
			...
			[5] = 'int32':lastEndTime	[上次月卡结束时间,0表示当前为首次购买]
		},
		[2] = {--ItemList
			[1] = {--repeated ItemInfo
				[1] = {--ChangeType(enum)
...
--]]
s2c.YOUCI_RSP_MAN_REFRESH_YOUCI = 9103
...
--]]
s2c.ACTIVITY_RES_FRIEND_HELP_ACTIVITY_PRE = 5190
