						...
						},
						{
							...
							components = 
							{
								...
								},
								{
									...
									components = 
									{
										
										{
											...
											sizeType = "0",
											srcBlendFunc = "770",
											text = "Las misiones solo se pueden completar en el evento de batalla final.",
											touchAble = "False",
											touchScaleEnable = "False",
											UILayoutViewModel = 
											{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Descripción de misión Descripción de misión Descripción de misión Descripción de misión",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
