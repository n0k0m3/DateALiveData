...
local TheaterBossResultView = class("TheaterBossResultView", BaseLayer)

function TheaterBossResultView:initData()
...
function TheaterBossResultView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:init("lua.uiconfig.battle.theaterBossResultView")
end

function TheaterBossResultView:initUI(ui)
...
function TheaterBossResultView:refreshView()
    ...
    self.Label_hurt:setText(self.statistics_.hitValue)
...
function TheaterBossResultView:registerEvents()
...
function TheaterBossResultView:updateReward()
...
function TheaterBossResultView:runAnimationIn()
...
function TheaterBossResultView:createHeroModel()
