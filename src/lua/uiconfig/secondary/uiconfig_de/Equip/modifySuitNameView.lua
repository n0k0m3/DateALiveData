						...
						
						{
							...
							components = 
							{
								
								{
									...
									components = 
									{
										
										{
											...
											placeHolder = "Bitte gib einen neuen Namen ein",
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Bitte gib einen neuen Voreinstellungsnamen ein",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Voreinstellungsname bearbeiten |",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
