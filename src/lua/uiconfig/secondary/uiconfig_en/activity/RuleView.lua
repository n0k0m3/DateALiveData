				...
				
				{
					...
					components = 
					{
						...
						},
						{
							...
							components = 
							{
								
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "500 gift pack coins launched",
									touchAble = "False",
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "770",
							text = "Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang Zhang",
							touchAble = "False",
							touchScaleEnable = "False",
							UILayoutViewModel = 
							{
