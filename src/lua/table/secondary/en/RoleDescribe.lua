return {
    ...
    [113101] = {
        ...
        energyExplain = "       In [Haste Mode], restores Wind Spirit by using Base ATK and extra skills. At max Wind Spirit, Ais enters [Attack Mode], gaining 50% DMG Bonus while losing Wind Spirit gradually. At 0 Wind Spirit, returns to [Haste Mode].",
        camp = "Spirit",
        energyicon = "icon/angleEnergy/31.png",
        colour = "",
        energyReply = "Restore: [Haste Mode] Base ATK/[Bless of Wind]",
        energyMin = "Initial: 0",
        skillName1 = "Energize",
        skillName3 = "DPS",
        id = 113101,
