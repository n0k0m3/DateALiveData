				...
				},
				{
					...
					components = 
					{
														...
														},
														{
															...
															components = 
															{
																
																{
																	...
																	sizeType = "0",
																	srcBlendFunc = "770",
																	text = "Erhalten durch [Purpurroter Alptraum]",
																	touchAble = "False",
																	touchScaleEnable = "False",
																	UILayoutViewModel = 
																	{
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "770",
							text = "Tippe zum Fortfahren auf eine beliebige Stelle",
							touchAble = "False",
							touchScaleEnable = "False",
							UILayoutViewModel = 
							{
