			...
			components = 
			{
				
				{
					...
					components = 
					{
						...
						{
							controlID = "Image_editJoinLimitView_1_Panel_base_Panel-editJoinLimitView_Layer1_league_Game",
							UUID = "12d73419_11bc_4b91_bf22_b6b7a55529c6",
							anchorPoint = "False",
							anchorPointX = "0.5",
							anchorPointY = "0.5",
							backGroundScale9Enable = "False",
							...
							sizeType = "0",
							srcBlendFunc = "770",
							texturePath = "ui/league/社团设置弹窗1 拷贝.jpg",
							touchAble = "False",
							UILayoutViewModel = 
							{
								PositionX = 568,
