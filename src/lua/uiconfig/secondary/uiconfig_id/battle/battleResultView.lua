														...
														},
														{
															...
															components = 
															{
																
																{
																	...
																	sizeType = "0",
																	srcBlendFunc = "770",
																	text = "Diperoleh setelah dapat [Crimson Nightmare]",
																	touchAble = "False",
																	touchScaleEnable = "False",
																	UILayoutViewModel = 
																	{
