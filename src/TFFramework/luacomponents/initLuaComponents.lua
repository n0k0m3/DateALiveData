...
require('TFFramework.luacomponents.common.TFMultiTouchPanel')
require('TFFramework.luacomponents.common.TFBarrage')
require('TFFramework.luacomponents.common.TFBarrageEx')
