return {
    ...
    [111601] = {
        ...
        energyExplain = "       Mikoto Misaka's skills cost Psychic Power, which replenishes at a rate of 3 per second in battle. [Note: EMP State reduces target's Lightning Resist by 10%. Stacks up to 3 layers. Lasts 7s. Attack enemy inflicted by EMP has 5% higher Crit Rate and ",
        camp = "Esper",
    ...
    [111701] = {
        ...
        energyExplain = "       Kuroko Shirai's skills cost Psychic Power, which replenishes at a rate of 3 per second when in battle. Attacks a random enemy with steel needles once every 3s while in battle and inflicts Physical DMG equal to 50% of ATK, effective even character i",
        camp = "Esper",
        energyicon = "icon/angleEnergy/20.png",
        colour = "",
        energyReply = "Restore: Restores 3 Energy per second.",
