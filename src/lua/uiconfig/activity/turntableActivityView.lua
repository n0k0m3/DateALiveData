local t = 
{
	...
	components = 
	{
		
		{
			...
			UUID = "39364ad5_f4b7_4b3d_a216_670b207e256d",
			anchorPoint = "False",
			anchorPointX = "0",
			anchorPointY = "0",
				...
				
				{
					...
					components = 
					{
						
						{
							...
							sizeType = "0",
							srcBlendFunc = "1",
							texturePath = "ui/activity/turtableActivity/bg1.png",
							touchAble = "False",
							UILayoutViewModel = 
							{
						...
						},
						{
							...
							ignoreSize = "True",
							name = "btn_goto",
							normal = "ui/activity/turtableActivity/btn_go.png",
							pressed = "ui/activity/turtableActivity/btn_go.png",
							sizepercentx = "0",
							sizepercenty = "0",
							sizeType = "0",
							srcBlendFunc = "1",
	...
	respaths = 
	{
		textures = 
		{
			"ui/activity/turtableActivity/bg1.png",
			"ui/activity/turtableActivity/btn_go.png",
		},
		armatures = 
		{
