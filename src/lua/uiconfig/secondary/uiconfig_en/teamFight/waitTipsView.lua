						...
						},
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "The Team Leader is offline",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Captain is changing, please wait",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
						...
						},
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "The seven characters of the player’s name will become the new captain",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Restart the battle in seconds",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
