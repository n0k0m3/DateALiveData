				...
				
				{
					...
					components = 
					{
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "770",
							text = "Your following items will expire in 1 day",
							touchAble = "False",
							touchScaleEnable = "False",
							UILayoutViewModel = 
							{
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "770",
							text = "Your following items will expire in 3 days",
							touchAble = "False",
							touchScaleEnable = "False",
							UILayoutViewModel = 
							{
						...
						{
							controlID = "Label_title-Copy1_Panel_base_Panel-overduePromptView_Layer1_bag_Game",
							UUID = "98478f89_e656_440e_bd10_3ae806de5e7f",
							anchorPoint = "False",
							anchorPointX = "0",
							anchorPointY = "0.5",
							classname = "MELabel",
							...
							sizeType = "0",
							srcBlendFunc = "770",
							text = "Please use it as soon as possible. The item will automatically disappear after expiration",
							touchAble = "False",
							touchScaleEnable = "False",
							UILayoutViewModel = 
							{
