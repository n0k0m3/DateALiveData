local LinkageHwxStarTaskView = class("LinkageHwxStarTaskView", BaseLayer)

function LinkageHwxStarTaskView:initData(levelGroupId)
    ...
    self.diffReward_ = self.levelGroupCfg_.reward[1] or {}
...
function LinkageHwxStarTaskView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:showPopAnim(true)
    self:init("lua.uiconfig.linkageHwx.linkageHwxStarRewardView")
end

function LinkageHwxStarTaskView:initUI(ui)
...
function LinkageHwxStarTaskView:refreshView()
    local jumpIndex
...
function LinkageHwxStarTaskView:addStarItem()
...
function LinkageHwxStarTaskView:updateStarItem(item, id)
...
function LinkageHwxStarTaskView:registerEvents()
...
function LinkageHwxStarTaskView:onGetLevelGroupRewardEvent(diff, id)
