...
local DfwSummerStepRewardView = class("DfwSummerStepRewardView", BaseLayer)

function DfwSummerStepRewardView:initData()
...
function DfwSummerStepRewardView:ctor(...)
...
function DfwSummerStepRewardView:refreshView()
    self.Label_name:setTextById(13210008)

    self:updateAllTaskItem()
end

function DfwSummerStepRewardView:registerEvents()
...
function DfwSummerStepRewardView:addTaskItem()
    local foo = {}
...
function DfwSummerStepRewardView:updateAllTaskItem()
...
function DfwSummerStepRewardView:onSubmitSuccessEvent(activitId, itemId, reward)
    if self.activityId_ ~= activitId then return end
    Utils:showReward(reward)
    self:updateAllTaskItem()
end

function DfwSummerStepRewardView:onUpdateProgressEvent()
    self:updateAllTaskItem()
end

return DfwSummerStepRewardView
