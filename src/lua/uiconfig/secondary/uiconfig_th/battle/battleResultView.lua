														...
														},
														{
															...
															components = 
															{
																
																{
																	...
																	sizeType = "0",
																	srcBlendFunc = "770",
																	text = "ได้มาจากการได้รับ [คริมสัน ไนท์แมร์]",
																	touchAble = "False",
																	touchScaleEnable = "False",
																	UILayoutViewModel = 
																	{
