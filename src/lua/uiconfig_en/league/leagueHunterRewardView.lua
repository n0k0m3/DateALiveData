					...
					components = 
					{
						
						{
							...
							components = 
							{
								...
								{
									controlID = "Label_first_Image_bg_Panel_root_Panel-leagueHunterRewardView_Layer1_league_Game",
								...
								{
									controlID = "Label_kill_Image_bg_Panel_root_Panel-leagueHunterRewardView_Layer1_league_Game",
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Annihilation rewards will be delivered at the end of this phase",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
