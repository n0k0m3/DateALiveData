...
me.pointMT.__tostring = function (t) 
    if t.force then 
        return string.format('{point:x=%.2f, y=%.2f, sx=%.2f, sy=%.2f, force=%.2f, maxForce=%.2f}', t.x, t.y, t.sx, t.sy, t.force, t.maxForce) 
    else 
        return string.format('{point:x=%.2f, y=%.2f}', t.x, t.y) 
    end
end
