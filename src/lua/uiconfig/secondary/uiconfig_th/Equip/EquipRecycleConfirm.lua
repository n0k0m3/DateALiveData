						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "ในแต่ละรอบ เซฟิร่าและของที่ระลึก ที่ติดตั้งบนตัวสปิริต จะถูกผูกไว้กับพวกมัน ซึ่งหมายความว่าสปิริตอื่นๆ จะไม่สามารถใช้มันได้ (สามารถใช้ของใน กระเป๋าได้แล้ว)",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
