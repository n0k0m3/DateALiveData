local KsOutbountTaskView = class("KsOutbountTaskView",BaseLayer)


function KsOutbountTaskView:initData()
    self.task_ = {}
...
function KsOutbountTaskView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:setUsepreProcesUI()
    self:init("lua.uiconfig.activity.ksOutbountTaskView")
end

function KsOutbountTaskView:initUI(ui)
...
function KsOutbountTaskView:registerEvents()
...
function KsOutbountTaskView:addTaskItem()
...
function KsOutbountTaskView:refreshView()
