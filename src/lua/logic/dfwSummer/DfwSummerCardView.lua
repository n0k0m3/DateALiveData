...
local DfwSummerCardView = class("DfwSummerCardView", BaseLayer)

function DfwSummerCardView:initData()
    self.buffData_ = DfwDataMgr:getChessesBuff()
    self.defaultSelectIndex_ = 1
end

function DfwSummerCardView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:showPopAnim(true)
    self:init("lua.uiconfig.dafuwong.dfwSummerCardView")
end

function DfwSummerCardView:initUI(ui)
...
function DfwSummerCardView:refreshView()
...
function DfwSummerCardView:selectCard(index)
...
function DfwSummerCardView:registerEvents()
...
function DfwSummerCardView:onUpdateBuffEvent()
    AlertManager:closeLayer(self)
end

return DfwSummerCardView
