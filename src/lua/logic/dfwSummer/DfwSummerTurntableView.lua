...
local DfwSummerTurntableView = class("DfwSummerTurntableView", BaseLayer)

function DfwSummerTurntableView:initData()
...
function DfwSummerTurntableView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:init("lua.uiconfig.dafuwong.dfwSummerTurntableView")
end

function DfwSummerTurntableView:initUI(ui)
...
function DfwSummerTurntableView:refreshView()
...
function DfwSummerTurntableView:updateTurntableState()
...
function DfwSummerTurntableView:updateTurntableInfo()
    for i, foo in ipairs(self.turntableItems_) do
        local cfg = DfwDataMgr:getTurntableCfg(self.turntable_[i])
...
function DfwSummerTurntableView:addTurntableItem()
...
function DfwSummerTurntableView:nextTurnTable()
...
function DfwSummerTurntableView:startTheDraw()
...
function DfwSummerTurntableView:updateMethod()
...
function DfwSummerTurntableView:continueTheDraw()
    local count = 1
...
function DfwSummerTurntableView:endTheDraw()
...
function DfwSummerTurntableView:registerEvents()
...
function DfwSummerTurntableView:onLuckyWheelEvent(turnInfo, rewards)
    self.rewards_ = rewards
    self.targetIndex_ = turnInfo.turnIndex
    self:startTheDraw()
end

return DfwSummerTurntableView
