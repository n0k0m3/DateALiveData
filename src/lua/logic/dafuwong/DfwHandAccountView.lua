...
local DfwHandAccountView = class("DfwHandAccountView", BaseLayer)

function DfwHandAccountView:initData()
    self.handAccount_ = DfwDataMgr:getHandAccount(EC_HadleAccountType.Spring)
...
function DfwHandAccountView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:init("lua.uiconfig.dafuwong.dfwHandAccountView")
end

function DfwHandAccountView:initUI(ui)
...
function DfwHandAccountView:refreshView()
...
function DfwHandAccountView:selectTab(index)
...
function DfwHandAccountView:addContentItem(index)
...
function DfwHandAccountView:registerEvents()

end

function DfwHandAccountView:updateTab(index)
    local handAccount = self.handAccount_
