						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Los siguientes jugadores están contendiendo por la elección del líder",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "El miembro con la contribución más alta se convertirá en el próximo líder.",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
