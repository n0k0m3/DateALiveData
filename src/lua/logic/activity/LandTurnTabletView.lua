...
function LandTurnTabletView:initUI(ui)
    ...
    self._ui.label_timeBegin:setTextById(1410001, Utils:getUTCDateYMD(self.activityInfo.startTime ,true ,  GV_UTC_TIME_ZONE))
    self._ui.label_timeEnd:setText(TextDataMgr:getText(1410001, Utils:getUTCDateYMD(self.activityInfo.endTime ,true, GV_UTC_TIME_ZONE))..GV_UTC_TIME_STRING)
