local t = 
{
				...
				
				{
					...
					components = 
					{
						
						{
							...
							sizeType = "0",
							srcBlendFunc = "1",
							texturePath = "ui/summon/elf_contract/002.png",
							touchAble = "False",
							UILayoutViewModel = 
							{
						...
						},
						{
							...
							ignoreSize = "True",
							name = "Button_details",
							normal = "ui/summon/elf_contract/001.png",
							sizepercentx = "0",
							sizepercenty = "0",
							sizeType = "0",
							srcBlendFunc = "1",
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "1",
							texturePath = "ui/summon/elf_contract/006.png",
							touchAble = "False",
							UILayoutViewModel = 
							{
								PositionX = 328,
							...
							components = 
							{
								...
								{
									controlID = "Label_title_Image_task_Panel_root_Panel-summonContractMainView_Layer1_summon_Game",
									UUID = "773ed654_a8fa_4b49_9ee5_97e9749441fc",
									anchorPoint = "False",
									anchorPointX = "0.5",
									anchorPointY = "0.5",
									classname = "MELabel",
								...
								{
									controlID = "Label_cur_level_Image_task_Panel_root_Panel-summonContractMainView_Layer1_summon_Game",
									...
									components = 
									{
										...
										{
											controlID = "Label_level_Label_cur_level_Image_task_Panel_root_Panel-summonContractMainView_Layer1_summon_Game",
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "1",
							texturePath = "ui/summon/elf_contract/005.png",
							touchAble = "False",
							UILayoutViewModel = 
							{
								PositionX = -248,
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "(You can purchase and activate it again after level 60)",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
						...
						
						{
							...
							components = 
							{
								
								{
									...
									ignoreSize = "True",
									name = "Button_task",
									normal = "ui/summon/elf_contract/007.png",
									sizepercentx = "0",
									sizepercenty = "0",
									sizeType = "0",
									srcBlendFunc = "1",
	...
	respaths = 
	{
		textures = 
		{
			"ui/summon/elf_contract/002.png",
			"ui/summon/elf_contract/title_tip.png",
			"ui/summon/elf_contract/001.png",
			"ui/summon/elf_contract/006.png",
			"ui/common/scroll_bar_01.png",
			"ui/common/scroll_bar_02.png",
			"ui/summon/elf_contract/005.png",
			...
			"ui/summon/elf_contract/007.png",
