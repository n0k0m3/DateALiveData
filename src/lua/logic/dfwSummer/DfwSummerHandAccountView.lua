...
local DfwSummerHandAccountView = class("DfwSummerHandAccountView", BaseLayer)

function DfwSummerHandAccountView:initData()
    self.handAccount_ = DfwDataMgr:getHandAccount(EC_HadleAccountType.Summer)
...
function DfwSummerHandAccountView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:init("lua.uiconfig.dafuwong.dfwSummerHandAccountView")
end

function DfwSummerHandAccountView:initUI(ui)
    ...
    self.Label_name = TFDirector:getChildByPath(self.Image_chunriji, "Image_name.Label_name")
...
function DfwSummerHandAccountView:refreshView()
...
function DfwSummerHandAccountView:selectTab(index)
...
function DfwSummerHandAccountView:addContentItem(index)
    ...
    foo.Label_name = TFDirector:getChildByPath(Image_content, "Image_name.Label_name")
...
function DfwSummerHandAccountView:registerEvents()

end

function DfwSummerHandAccountView:updateTab(index)
    local handAccount = self.handAccount_
...
return DfwSummerHandAccountView
