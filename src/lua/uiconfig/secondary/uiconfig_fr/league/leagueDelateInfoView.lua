						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Les joueurs suivants sont en lice pour une élection de chef",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "Le membre ayant la contribution hebdomadaire la plus élevée deviendra le prochain leader.",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
