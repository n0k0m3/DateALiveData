...
function SxBirthdayTravelView:updateAllTaskItem()
    ...
    for i, v in ipairs(tempTaskData) do
        ...
        foo.Label_name:setText(Utils:MultiLanguageStringDeal(taskInfo.extendData.des2))
        foo.Label_name_geted:setText(Utils:MultiLanguageStringDeal(taskInfo.extendData.des2))
