...
function EquipSuitStarUpSuccess:refreshView()
    ...
    self.Label_level_now:setString(tostring(equipInfo.level).."/"..maxLevel)
...
function EquipSuitStarUpSuccess:registerEvents()
