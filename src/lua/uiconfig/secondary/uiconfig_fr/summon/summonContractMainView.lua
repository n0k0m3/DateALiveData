						...
						},
						{
							...
							components = 
							{
								
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "L’invocation d'esprit se termine dans",
									touchAble = "False",
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "(Vous pouvez l’acheter et l’activer à nouveau après le niveau 60)",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
