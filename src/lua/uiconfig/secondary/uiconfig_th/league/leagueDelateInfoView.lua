						...
						
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "ผู้เล่นต่อไปนี้กำลังแข่งขันเพื่อชิงตำแหน่งหัวหน้า",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "สมาชิกที่มีผลงานสูงสุดประจำสัปดาห์จะกลายเป็นหัวหน้าคนต่อไป",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
