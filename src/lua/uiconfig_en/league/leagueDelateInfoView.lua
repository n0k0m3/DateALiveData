			...
			components = 
			{
				
				{
					...
					components = 
					{
						...
						{
							controlID = "Image_leagueDelateInfoView_1_Panel_base_Panel-leagueDelateInfoView_Layer1_league_Game",
							UUID = "107a2234_b7e8_47c4_b5cf_a982f0f9e02c",
							anchorPoint = "False",
							anchorPointX = "0.5",
							anchorPointY = "0.5",
							backGroundScale9Enable = "False",
							...
							sizeType = "0",
							srcBlendFunc = "770",
							texturePath = "ui/league/弹劾列表.jpg",
							touchAble = "False",
							UILayoutViewModel = 
							{
								PositionX = 573,
						...
						},
						{
							...
							components = 
							{
								...
								},
								{
									...
									sizeType = "0",
									srcBlendFunc = "770",
									text = "The following players are contesting for a leader election",
									touchAble = "False",
									touchScaleEnable = "False",
									UILayoutViewModel = 
									{
