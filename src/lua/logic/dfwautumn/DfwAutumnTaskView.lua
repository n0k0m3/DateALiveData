...
local DfwAutumnTaskView = class("DfwAutumnTaskView", BaseLayer)

function DfwAutumnTaskView:initData()
...
function DfwAutumnTaskView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:init("lua.uiconfig.dafuwong.dfwAutumnTaskView")
end

function DfwAutumnTaskView:initUI(ui)
...
function DfwAutumnTaskView:initTask()
...
function DfwAutumnTaskView:updateAllTask()
...
function DfwAutumnTaskView:updateRefreshInfo()
...
function DfwAutumnTaskView:refreshView()
    self:initTask()
    self:updateRefreshInfo()
end

function DfwAutumnTaskView:registerEvents()
...
function DfwAutumnTaskView:onBuyInfoUpdateEvent()
end

function DfwAutumnTaskView:onRefreshEvent(storeId)
    self:updateAllTask()
    self:updateRefreshInfo()
end

function DfwAutumnTaskView:onItemUpdateEvent()

end

function DfwAutumnTaskView:onBuySuccessEvent(data)
    self:updateAllTask()
