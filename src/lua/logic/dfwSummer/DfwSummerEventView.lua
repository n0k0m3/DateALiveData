...
local DfwEventView = class("DfwEventView", BaseLayer)

function DfwEventView:initData(eventCid, baseReward, additionReward)
...
function DfwEventView:ctor(...)
    self.super.ctor(self)
    self:initData(...)
    self:showPopAnim(true)
    self:init("lua.uiconfig.dafuwong.dfwSummerEventView")
end

function DfwEventView:initUI(ui)
...
function DfwEventView:refreshView()
...
function DfwEventView:registerEvents()
